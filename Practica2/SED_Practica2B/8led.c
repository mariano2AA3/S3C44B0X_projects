...
#define DIGIT_L (SEGMENT_G & SEGMENT_E & SEGMENT_D & SEGMENT_P)
#define DIGIT_P (SEGMENT_A & SEGMENT_B & SEGMENT_F & SEGMENT_G & SEGMENT_E & SEGMENT_P)
#define DIGIT_VACIO ~(SEGMENT_A & SEGMENT_B & SEGMENT_C & SEGMENT_D & SEGMENT_E & SEGMENT_F & SEGMENT_G & SEGMENT_P)

/*--- variables globales ---*/
/* tabla de segmentos */
int Symbol[] = {DIGIT_0, DIGIT_1, DIGIT_2, DIGIT_3, DIGIT_4, DIGIT_5,
					DIGIT_6, DIGIT_7, DIGIT_8, DIGIT_9, DIGIT_A, DIGIT_B,
					DIGIT_C, DIGIT_D, DIGIT_E, DIGIT_F, DIGIT_L, DIGIT_P, DIGIT_VACIO};
