	...
	/* Esperar trp mediante la funcion DelayMs() */
		...
		if(key > -1) {
			...
			switch(key) {
				...
				case 1:
					cambiar_direccion_jugador1(DIRECCION_ABAJO);
				break;
				case 2:
					cambiar_direccion_jugador1(DIRECCION_ABAJO);
				break;
				case 4:
					cambiar_direccion_jugador1(DIRECCION_IZQ);
				break;
				case 8:
					cambiar_direccion_jugador1(DIRECCION_IZQ);
				break;
				case 7:
					cambiar_direccion_jugador1(DIRECCION_DER);
				break;
				case 11:
					cambiar_direccion_jugador1(DIRECCION_DER);
				break;
				case 13:
					cambiar_direccion_jugador1(DIRECCION_ARRIBA);
				break;
				case 14:
					cambiar_direccion_jugador1(DIRECCION_ARRIBA);
				break;
